...
<html>
  ...
  <body class="bg-white flex">
    ...
    <!-- Sidebar -->
    <div
      class="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-64 overflow-y-auto text-center bg-green-950 hidden lg:block"
      id="sidebar"
    >
      ...
      <div
        class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer sidebar-item"
      ...
      <div
        class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer sidebar-item"
        data-section="hospitals"
        onclick="showSection('hospitals')"
      >
      ...
      <div
        class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer sidebar-item"
        data-section="nurses"
        onclick="showSection('nurses')"
      >
        <span class="text-[15px] font-bold">Nurses</span>
      </div>
      <div
        class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer sidebar-item"
        data-section="midwife"
        onclick="showSection('midwife')"
      >
      ...
      <div
        class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white sidebar-item"
    ...
    <div class="content flex-1 ml-64 lg:ml-80 p-4 relative">
      <div id="dashboard" class="section hidden p-6">
        ...
        <div class="welcome-box bg-white p-6 rounded-lg shadow-lg mb-8">
          <div
            class="flex flex-col md:flex-row items-center md:items-start mb-4"
          >
            <!-- Admin Picture -->
            <img
        ...
        <div class="add-staff-section my-8">
          <div class="flex justify-around">
            <!-- Add Doctor Box -->
            <div
              class="add-box bg-blue-500 text-black p-6 rounded-lg shadow-lg cursor-pointer"
            ...
            <!-- Add Nurse Box -->
            <div
              class="add-box bg-green-500 text-black p-6 shadow-lg cursor-pointer"
            ...
            <!-- Add Midwife Box -->
            <div
              class="add-box bg-purple-500 text-black p-6 rounded-lg shadow-lg cursor-pointer"
    ...
    <div class="p-4">
        <input type="text" id="searchInput" onkeyup="searchDoctors()" placeholder="Search for doctors..." class="w-full p-2 border-2 border-gray-300 rounded-lg" />
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
      ...
      <div id="Add_Doctor" class="section hidden">
        <div class="p-6 bg-white rounded-lg shadow-lg max-w-3xl mx-auto">
          <img
            ...
            onclick="goBack()"
            class="back-arrow cursor-pointer mb-4"
            alt="Back"
          />
          <h2
            class="text-3xl font-extrabold mb-6 text-gray-800 mb-4 text-center font-bold"
          >
            Add New Doctor
          </h2>
          <form class="space-y-8" id="doctorForm" method="post" onsubmit="submitDoctorForm(event)">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="col-span-2" style="margin-bottom: 15px">
                <label
                  for="LastName"
                  class="block text-gray-700 font-semibold mb-2 label-doctor"
                  >Last Name</label
                >
                <input
                  type="text"
    ...
    >
      <div
        class="bg-white p-6 rounded-md shadow-lg w-11/12 md:w-1/3"
        style="z-index: 999"
      >
        ...
        <div class="flex justify-end">
          <button
            onclick="hideModal()"
            class="px-4 py-2 bg-gray-300 text-black rounded-md mr-2"
          >
            Cancel
          </button>
          <button
